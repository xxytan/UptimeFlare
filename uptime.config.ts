...
const workerConfig: WorkerConfig = {
  ...
  monitors: [
    ...
    // },
    {
      ...
      name: '个人主页',
      method: 'HEAD',
      target: 'https://www.oxue.de/',
      statusPageLink: 'https://www.oxue.de/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    ...
    },
    {
      ...
      name: '短链',
      method: 'HEAD',
      target: 'https://oxue.de/',
      statusPageLink: 'https://oxue.de/dashboard/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '邮箱',
      method: 'HEAD',
      target: 'https://mail.oxue.de',
      statusPageLink: 'https://mail.oxue.de',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
    {
      ...
      name: '内容分发',
      method: 'HEAD',
      target: 'https://d.oxue.de/',
      statusPageLink: 'https://d.oxue.de/',
      hideLatencyChart: false,
      expectedCodes: [200],
      timeout: 10000,
    },
